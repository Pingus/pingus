...
public:
  ...
  sigc::signal<void(int)> on_master_volume_change;

  void set_sound_volume(int);
  int  get_sound_volume() const;
  sigc::signal<void(int)> on_sound_volume_change;
  ...
  sigc::signal<void(bool)> on_fullscreen_change;

  void set_renderer(FramebufferType type);
  FramebufferType get_renderer() const;
  sigc::signal<void(FramebufferType)> on_renderer_change;

  void set_resizable(bool);
  bool get_resizable() const;
  sigc::signal<void(bool)> on_resizable_change;

  void set_mouse_grab(bool);
  bool get_mouse_grab() const;
  sigc::signal<void(bool)> on_mouse_grab_change;
  ...
  sigc::signal<void(bool)> on_software_cursor_change;

  void set_auto_scrolling(bool);
  bool get_auto_scrolling() const;
  sigc::signal<void(bool)> on_auto_scrolling_change;
