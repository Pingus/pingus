;; generated by xml2sexpr.rb from file 'branches/pingus_0_6/data/levels/tutorial/snow7-grumbel.pingus'
(pingus-level 
  (version 2)
  (head 
    (levelname "One must prepare, the rest must follow")
    (description "Sometimes there are situations where you don't have a Blocker at hand to "
    ...
    (description "Det er ikke i alle baner, at du har en Spærre-Pingu til at holde styr på "
                 "de andre. Du bliver så nødt til at finde på andre måde at kontrollere "
                 "dem på, mens en fortrop bereder vejen for resten. ")
  ...
  (objects 
    (surface-background 
      ...
      (stretch-y 0)
      (keep-aspect 0)
      (position 17.4 -109.8 -150))
    (hotspot 
      (surface 
        (image "entrances/snow_back")
        (modifier "ROT0"))
      (position 245.006 148.941 -50)
      (speed -1)
      (parallax 1))
    (groundpiece 
      (type "ground")
