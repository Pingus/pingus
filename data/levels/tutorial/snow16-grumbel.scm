;; generated by xml2sexpr.rb from file 'branches/pingus_0_6/data/levels/tutorial/snow16-grumbel.pingus'
(pingus-level 
  (version 2)
  (head 
    (levelname "Bridging gets more complicated...")
    (description "Once again you have to combine actions carefully and wisely. If you don't "
  ...
  (objects 
    ...
    (exit 
      (owner-id 0)
      (position 1015.5 224 0)
      (surface 
        (image "exits/ice2")
        (modifier "ROT0"))
      (owner-id 0))
    (entrance 
      (position 240.5 114 0)
      (type "generic")
      (direction "right")
      (release-rate 100)
      (owner-id 0))
