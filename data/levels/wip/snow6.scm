;; generated by xml2sexpr.rb from file 'branches/pingus_0_6/data/levels/wip/snow6.pingus'
(pingus-level 
  (version 2)
  (head 
    (levelname "Dragon Illusion")
    (description )
    (author "Ingo Ruhnke <grumbel@gmx.de>")
    (number-of-pingus 120)
    (number-to-save 0)
    (time 9000)
    (comment "drop off on the far right is too high.. building up a bridge from the left "
             "would be a major hassle.. or just make this a very difficult level.")
    (actions 
      (basher 20)
      (blocker 20)
      (bomber 20)
