;; generated by xml2sexpr.rb from file 'branches/pingus_0_6/data/levels/wip/level2.pingus'
(pingus-level 
  (version 2)
  (head 
    (levelname "Which one is the right exit?")
    (description "A short demonstartion of the fake exit and of the new water animation.")
