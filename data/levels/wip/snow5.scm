;; generated by xml2sexpr.rb from file 'branches/pingus_0_6/data/levels/wip/snow5.pingus'
(pingus-level 
  (version 2)
  (head 
    (levelname "Snow 5 - Higher and higher")
    (description )
    (author "Ingo Ruhnke <grumbel@gmx.de>")
    (number-of-pingus 100)
    (number-to-save 0)
    (time 9000)
    (comment "this should be a space level as themed, for a space world")
    (actions 
      (basher 20)
      (blocker 20)
      (bomber 20)
  ...
  (objects 
    ...
    (groundpiece 
      ...
      (surface 
        (image "groundpieces/solid/rock/granit3")
        (modifier "ROT0"))
      (position 1403 1007 0))
    (groundpiece 
      (type "ground")
      (surface 
        (image "groundpieces/solid/rock/granit3")
        (modifier "ROT0"))
      (position 1425 1085 0))
    (groundpiece 
      (type "ground")
      (surface 
        (image "groundpieces/solid/rock/granit3")
