;; generated by xml2sexpr.rb convert script from '../../../pingus_sdl/data/levels/./playable/climber-tutorial-lukis.pingus'
(pingus-level 
  (version 2)
  (head 
    (levelname "It's climbers time!")
    (description "Discover The Pyramide")
    (author )
    (number-of-pingus 10)
    (number-to-save 5)
    (time -1)
