;; generated by xml2sexpr.rb convert script from '../../../pingus_sdl/data/levels/./playable/aliens2-phil.pingus'
(pingus-level 
  (version 2)
  (head 
    (levelname "Escape from Aliens 2")
    (description "Aliens are now closest making your escape  harder. You must dig it up.")
