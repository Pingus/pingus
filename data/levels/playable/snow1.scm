;; generated by xml2sexpr.rb convert script from '../../../pingus_sdl/data/levels/./playable/snow1.pingus'
(pingus-level 
  (version 2)
  (head 
    (levelname "A long way home")
    (description " ")
    (author "Ingo Ruhnke <grumbel@gmx.de>")
    (number-of-pingus 120)
    (number-to-save 80)
    (time 8000)
    (actions 
      (basher 25)
  ...
  (objects 
    ...
    (groundpiece 
      (type "ground")
      (surface 
        (image "global/Hotspots/left_arrow")
        (modifier "ROT0"))
      (position 1772 447 0))
    (groundpiece 
      (type "ground")
