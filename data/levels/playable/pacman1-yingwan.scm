;; generated by xml2sexpr.rb convert script from '../../../pingus_sdl/data/levels/./playable/pacman1-yingwan.pingus'
(pingus-level 
  (version 2)
  (head 
    (levelname "Pacman 1")
    (description "Get to Mr. Pacman and avoid all the nasty ghosties to bring the
Pingus home.")
