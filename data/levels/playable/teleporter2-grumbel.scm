;; generated by xml2sexpr.rb convert script from '../../../pingus_sdl/data/levels/./playable/teleporter2-grumbel.pingus'
(pingus-level 
  (version 2)
  (head 
  ...
  (objects 
    (surface-background 
      ...
      (position 0 0 -100))
    (entrance 
      (position 1127 501 -100)
      (type "woodthing")
      (direction "misc")
      (release-rate 50)
      (owner-id 0))
    (entrance 
      (position 521 366 -100)
      (type "woodthing")
      (direction "misc")
      (release-rate 50)
      (owner-id 0))
    ...
    (groundpiece 
      ...
      (surface 
        ...
        (modifier "ROT0"))
      (position 854.959 629.98 0))
    (groundpiece 
      (type "ground")
      (surface 
        (image "groundpieces/ground/misc/grey_stone5")
        (modifier "ROT0"))
      (position 998.959 648.98 0))
    (groundpiece 
      (type "ground")
      (surface 
        (image "groundpieces/ground/misc/grey_stone5")
        (modifier "ROT0"))
      (position 960.959 707.98 0))
    (groundpiece 
      (type "ground")
      (surface 
        (image "groundpieces/ground/misc/grey_stone5")
        (modifier "ROT0"))
      (position 819.959 810.98 0))
    (groundpiece 
      (type "ground")
      (surface 
        (image "groundpieces/ground/misc/grey_stone5")
