;; generated by xml2sexpr.rb convert script from '../../../pingus_sdl/data/levels/./playable/miner-tutorial-grumbel.pingus'
(pingus-level 
  (version 2)
  (head 
    (levelname "Tutorial 2 - Miners having fun")
    (description "Use the miner action and dig into the ground to reach the exit.")
