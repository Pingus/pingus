;; generated by xml2sexpr.rb convert script from '../../../pingus_sdl/data/levels/./playable/desert4.pingus'
(pingus-level 
  (version 2)
  (head 
    (levelname "PLE Level")
...
")
    ...
    (difficulty 60)
    (playable 1)
    (comment "actions not tuned and very similar to desert5.xml")
    (music "pingus-3.it")
    (actions 
      (basher 20)
      (blocker 20)
