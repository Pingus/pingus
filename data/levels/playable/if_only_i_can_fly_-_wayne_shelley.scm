;; generated by xml2sexpr.rb convert script from '../../../pingus_sdl/data/levels/./playable/if_only_i_can_fly_-_wayne_shelley.pingus'
(pingus-level 
  (version 2)
  (head 
    (levelname "If Only I Could Fly?")
    (description "Not quite as easy as it looks!")
    (author "Wayne Shelley (wayne@microtron.ath.cx)")
    (number-of-pingus 50)
    (number-to-save 40)
    (time -1)
    (difficulty 80)
