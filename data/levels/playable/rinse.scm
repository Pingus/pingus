;; generated by xml2sexpr.rb convert script from '../../../pingus_sdl/data/levels/./playable/rinse.pingus'
(pingus-level 
  (version 2)
  (head 
...
")
    ...
    (number-to-save 20)
    (time 9000)
    (comment "Pingu walk on air right above the plant.
    Also, Pingu get trapped in middle "
             "of plant and stuck on the
    left side of the map (at the top) too easily.")
    (actions 
      (basher 20)
      (blocker 10)
      (bomber 10)
