;; generated by xml2sexpr.rb convert script from '../../../pingus_sdl/data/levels/./playable/desert5.pingus'
(pingus-level 
  (version 2)
  (head 
    (levelname "PLE Level")
...
")
    ...
    (playable 1)
    (difficulty 75)
    (comment "floaters was 2, increased to 3, 'cause there doesn't seem
    to be a way "
             "to solve it cleanly with 2 floaters")
    (actions 
      (blocker 5)
      (bomber 20)
      (bridger 5)
