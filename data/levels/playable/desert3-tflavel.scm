;; generated by xml2sexpr.rb convert script from '../../../pingus_sdl/data/levels/./playable/desert3-tflavel.pingus'
(pingus-level 
  (version 2)
  (head 
    (levelname "Sandstorm")
    (description "Deep inside the pyrmaid the pingus are surprised to find their way
blocked "
