;; generated by xml2sexpr.rb convert script from '../../../pingus_sdl/data/levels/./playable/winter2-chei.pingus'
(pingus-level 
  (version 2)
  (head 
  ...
  (objects 
    ...
    (hotspot 
      (surface 
        ...
        (modifier "ROT0"))
      (position 55.668 22.2828 -50)
      (speed -1)
      (parallax 1))
    (entrance 
      (position 103.357 64.1426 0)
      (type "generic")
      (direction "right")
      (release-rate 150)
      (owner-id 0))
