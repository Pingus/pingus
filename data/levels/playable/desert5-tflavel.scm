;; generated by xml2sexpr.rb convert script from '../../../pingus_sdl/data/levels/./playable/desert5-tflavel.pingus'
(pingus-level 
  (version 2)
  (head 
    (levelname "Claustrophobia")
    (description "Hidden deep below the pyramid the pingus come across a small
underground "
