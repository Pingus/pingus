;; generated by xml2sexpr.rb from file 'branches/pingus_0_6/data/levels/playable/desert5-tflavel.pingus'
(pingus-level 
  (version 2)
  (head 
    (levelname "Claustrophobia")
    (description "Hidden deep below the pyramid the pingus come across a small underground "
