...
(pingus-resources
 ...
 (alias (name "global/Ywlam/pacbkg") 
        (link "special/pacman/pacman-bkg"))

 (alias (name "global/Ywlam/pacframe") 
        (link "special/pacman/pacman-frame"))

 (alias (name "global/Ywlam/pacmaze") 
        (link "special/pacman/pacman-maze"))

 (alias (name "global/Ywlam/pacman") 
        (link "special/pacman/pacman"))

 (alias (name "global/Ywlam/blinky") 
        (link "special/pacman/blinky"))

 (alias (name "global/Ywlam/inky")  
        (link "special/pacman/inky"))

 (alias (name "global/Ywlam/pinky")
        (link "special/pacman/pinky"))

 (alias (name "global/Ywlam/clyde") 
        (link "special/pacman/clyde"))
