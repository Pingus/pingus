  ...
  (section (name "groundpieces")
    (section (name "solid")
      ...
      (section (name "desert")
        ...
        (sprite
          (name "leftsmallbrick")
          (image (file "../images/groundpieces/solid/desert/leftsmallbrick.png")))

        (sprite
          (name "middlebrickpiece")
          (image (file "../images/groundpieces/solid/desert/middlebrickpiece.png")))

        (sprite
          (name "smallbrickpiece")
          (image (file "../images/groundpieces/solid/desert/smallbrickpiece.png")))
       )
      ...
      (section (name "misc")
        (sprite
          ...
          (image (file "../images/groundpieces/solid/misc/metalplate_horiz.png")))

        (sprite
          (name "metalplate_large")
          (image (file "../images/groundpieces/solid/misc/metalplate_large.png")))

        (sprite
          (name "metalplate_small")
          (image (file "../images/groundpieces/solid/misc/metalplate_small.png")))
