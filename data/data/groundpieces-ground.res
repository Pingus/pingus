 ...
 (section (name "groundpieces")
          (section (name "ground")
                   ...
                   (section (name "xmas")
                            (sprite
                             (name "ground1")
                             (image-file "../images/groundpieces/ground/xmas/ground1.png"))
                            (sprite
                             (name "ground2")
                             (image-file "../images/groundpieces/ground/xmas/ground2.png"))
                            (sprite
                             (name "ground3")
                             (image-file "../images/groundpieces/ground/xmas/ground3.png"))
                            (sprite
                             (name "iceblock")
                             (image-file "../images/groundpieces/ground/xmas/iceblock.png"))
                            (sprite
                             (name "pingu")
                             (image-file "../images/groundpieces/ground/xmas/pingu.png"))
                            (sprite
                             (name "snow1")
                             (image-file "../images/groundpieces/ground/xmas/snow1.png"))
                            (sprite
                             (name "snow2")
                             (image-file "../images/groundpieces/ground/xmas/snow2.png"))
                            (sprite
                             (name "snowball1")
                             (image-file "../images/groundpieces/ground/xmas/snowball1.png"))
                            (sprite
                             (name "snowball2")
                             (image-file "../images/groundpieces/ground/xmas/snowball2.png"))
                            (sprite
                             (name "snowball3")
                             (image-file "../images/groundpieces/ground/xmas/snowball3.png"))
                            (sprite
                             (name "snowball")
                             (image-file "../images/groundpieces/ground/xmas/snowball.png"))
                            (sprite
                             (name "snowman_coal1")
                             (image-file "../images/groundpieces/ground/xmas/snowman_coal1.png"))
                            (sprite
                             (name "snowman_coal2")
                             (image-file "../images/groundpieces/ground/xmas/snowman_coal2.png"))
                            (sprite
                             (name "snowman_nose")
                             (image-file "../images/groundpieces/ground/xmas/snowman_nose.png"))
                            (sprite
                             (name "tree")
                             (image-file "../images/groundpieces/ground/xmas/tree.png"))
                            )
                   ...
                   (section (name "crystal")
                            ...
                            (sprite
                             (name "skinnycrystal")
                             (image-file "../images/groundpieces/ground/crystal/skinnycrystal.png"))
                   ...
                   (section (name "desert")
                            (sprite
                             ...
                             (image-file "../images/groundpieces/ground/desert/bigblock-broken1.png"))

                            (sprite
                             (name "bigblock-broken2")
                             (image-file "../images/groundpieces/ground/desert/bigblock-broken2.png"))

                            (sprite
                             (name "bigblock-broken3")
                             (image-file "../images/groundpieces/ground/desert/bigblock-broken3.png"))
                            ...
                            (sprite
                             (name "bigprickpiece")
                             (image-file "../images/groundpieces/ground/desert/bigprickpiece.png"))
                            ...
                            (sprite
                             (name "column_piece1")
                             (image-file "../images/groundpieces/ground/desert/column_piece1.png"))

                            (sprite
                             (name "column_piece2")
                             (image-file "../images/groundpieces/ground/desert/column_piece2.png"))

                            (sprite
                             (name "column_piece3")
                             (image-file "../images/groundpieces/ground/desert/column_piece3.png"))
                            ...
                            (sprite
                             (name "leftsmallbrick")
                             (image-file "../images/groundpieces/ground/desert/leftsmallbrick.png"))

                            (sprite
                             (name "leftsmallsand")
                             (image-file "../images/groundpieces/ground/desert/leftsmallsand.png"))
                            ...
                            (sprite
                             ...
                             (image-file "../images/groundpieces/ground/desert/middleprickpiece.png"))
                            ...
                            (sprite
                             (name "platform_left")
                             (image-file "../images/groundpieces/ground/desert/platform_left.png"))

                            (sprite
                             (name "platform_right")
                             (image-file "../images/groundpieces/ground/desert/platform_right.png"))

                            (sprite
                             (name "rightsmallbrick")
                             (image-file "../images/groundpieces/ground/desert/rightsmallbrick.png"))

                            (sprite
                             (name "rightsmallsand")
                             (image-file "../images/groundpieces/ground/desert/rightsmallsand.png"))
                            ...
                            (sprite
                             ...
                             (image-file "../images/groundpieces/ground/desert/smallbrickpiece.png"))
                   ...
                   (section (name "jungle")
                            ...
                            (sprite
                             ...
                             (image-file "../images/groundpieces/ground/jungle/carabatreemedium.png"))

                            (sprite
                             (name "carabatreesmall")
                             (image-file "../images/groundpieces/ground/jungle/carabatreesmall.png"))
                   ...
                   (section (name "misc")
                            ...
                            (sprite
                             ...
                             (image-file "../images/groundpieces/ground/misc/column_flat_left.png"))

                            (sprite
                             (name "column_flat_right")
                             (image-file "../images/groundpieces/ground/misc/column_flat_right.png"))
                   ...
                   (section (name "signposts")
                            (sprite
                             (name "arrow_down")
                             (image-file "../images/groundpieces/ground/signposts/arrow_down.png"))

                            (sprite
                             (name "arrow_left")
                             (image-file "../images/groundpieces/ground/signposts/arrow_left.png"))

                            (sprite
                             (name "arrow_right")
                             (image-file "../images/groundpieces/ground/signposts/arrow_right.png"))
                   ...
                   (section (name "sortie")
                            ...
                            (sprite
                             ...
                             (image-file "../images/groundpieces/ground/sortie/plate_forme_left.png"))

                            (sprite
                             (name "plate_forme_right")
                             (image-file "../images/groundpieces/ground/sortie/plate_forme_right.png"))
                   ...
                   (section (name "sweets")
                            ...
                            (sprite
                             ...
                             (image-file "../images/groundpieces/ground/sweets/chocbloc-lowleft.png"))

                            (sprite
                             (name "chocbloc-lowright")
                             (image-file "../images/groundpieces/ground/sweets/chocbloc-lowright.png"))

                            (sprite
                             (name "chocbloc-topleft")
                             (image-file "../images/groundpieces/ground/sweets/chocbloc-topleft.png"))

                            (sprite
                             (name "chocbloc-topright")
                             (image-file "../images/groundpieces/ground/sweets/chocbloc-topright.png"))
                            ...
                            (sprite
                             (name "greenjellybaby")
                             (image-file "../images/groundpieces/ground/sweets/greenjellybaby.png"))
                            ...
                            (sprite
                             (name "lollipop-purp")
                             (image-file "../images/groundpieces/ground/sweets/lollipop-purp.png"))
